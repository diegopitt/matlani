...
export default function Albahaca() {
  const router = useRouter();
  return (
    <div>
      <Paper sx={{ position: 'relative', backgroundColor: '#f7dfca', color: '#fff', mb: 4, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundImage: `url(/albahaca.jpg)`, }}>
        {/* Increase the priority of the hero background image */}
        {<img style={{ display: 'none' }} src="/albahaca.jpg" alt="" />}
            ...
            <Grid item xs={12} md={8} sx={{ '& .markdown': { py: 3, }, }}>
              ...
              <Typography variant="h6" gutterBottom>
                ...
                <Typography variant="h6" gutterBottom color="inherit" sx={{ mt: 3 }}>
                  Ayuda a la lenta <b>digestión</b>, <b>gastritis</b>, <b>parásitos</b>, <b>gases intestinales</b>. Auxiliar en mareos, dolores de cabeza, tos y en casos de <b>depresión</b>
                </Typography>
