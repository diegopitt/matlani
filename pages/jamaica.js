          ...
          <Grid container spacing={5}>
            <Grid item xs={12} md={8} sx={{ '& .markdown': { py: 3,}, }}>
              <Paper sx={{ position: 'relative', backgroundColor: 'grey.200', p: 4, }}>
                ...
                Extraordinario para normalizar la presión alta (hipertensión), contiene antioxidantes, auxiliar en la reducción de niveles de colesterol y para limpiar sangre y riñones
                </Typography>
