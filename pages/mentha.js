...
export default function Mentha() {
  const router = useRouter();
  return (
    <div>
      <Paper sx={{ position: 'relative', backgroundColor: '#f7dfca', color: '#fff', mb: 4, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundImage: `url(/mentha.jpg)`, }}>
          ...
          <Grid container spacing={5}>
            <Grid item xs={12} md={8} sx={{ '& .markdown': { py: 3, }, }}>
              ...
              <Typography variant="h6" gutterBottom>
                ...
                Es eficaz mejorando la funcion <b>biliar</b>; contra la <b>mala digestión</b>, <b>espamos</b> y <b>gases intestinales</b>
                </Typography>
                <List sx={{ width: '100%', bgcolor: 'transparent' }}>
                  <ListItem>
                    ...
                    <ListItemText primary="Auxiliar contra dolores de cabeza, mareos, vertigo y afecciones respiratorias en general" />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                      <FilterVintageTwoToneIcon sx={{ color: '#6e5b4b' }} />
