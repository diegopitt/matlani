...
export default function Cuachalalate() {
  const router = useRouter();
  return (
    <div>
      <Paper sx={{ position: 'relative', backgroundColor: '#f7dfca', color: '#fff', mb: 4, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundImage: `url(/cuacha.jpg)`, }}>
        {/* Increase the priority of the hero background image */}
        {<img style={{ display: 'none' }} src="/cuacha.jpg" alt="" />}
        ...
        <Grid container>
          <Grid item md={6}>
            ...
            <Box sx={{ position: 'relative', p: { xs: 3, md: 6 }, pr: { md: 0 }, }}>
              <Typography component="h1" variant="h4" sx={{ pt: 5.5 }}>
                CUACHALALATE
              </Typography>
          ...
          <Grid container spacing={5}>
            <Grid item xs={12} md={8} sx={{ '& .markdown': { py: 3, }, }}>
              ...
              <Typography variant="h6" gutterBottom>
                ...
                Antibiótico, antiinflamatorio, auxiliar en el tratamiento de gastritis y Cáncer.
                </Typography>
