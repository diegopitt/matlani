...
export default function Pericon() {
  const router = useRouter();
  return (
    <div>
      <Paper sx={{ position: 'relative', backgroundColor: '#f7dfca', color: '#fff', mb: 4, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundImage: `url(/lucida.jpg)`, }}>
        {/* Increase the priority of the hero background image */}
        {<img style={{ display: 'none' }} src="/lucida.jpg" alt="" />}
          ...
          <Grid container spacing={5}>
            <Grid item xs={12} md={8} sx={{ '& .markdown': { py: 3, }, }}>
              ...
              <Typography variant="h6" gutterBottom>
                ...
                Eficiente contra problemas <b>nerviosos</b>, ansiedad, estrés, depresión e insomnio. Óptimo contra diarrea, disentería, parásitos, tifoidea, vómito y cólicos estomacales
                </Typography>
                <List sx={{ width: '100%', bgcolor: 'transparent' }}>
                  <ListItem>
                    ...
                    <ListItemText primary=" Auxiliar en el tratamiento de reumatismo, resfriado común, asma, cálculos renales, sarpullido infantil e incluso paludismo" />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                      <FilterVintageTwoToneIcon sx={{ color: '#6e5b4b' }} />
