...
export default function Damiana() {
  ...
  return (
    <div>
      <Paper sx={{ position: 'relative', backgroundColor: '#f7dfca', color: '#fff', mb: 4, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundImage: `url(/damiana.jpg)`, }}>
        {/* Increase the priority of the hero background image */}
        {<img style={{ display: 'none' }} src="/damiana.jpg" alt="" />}
          ...
          <Grid container spacing={5}>
            <Grid item xs={12} md={8} sx={{ '& .markdown': { py: 3, }, }}>
              ...
              <Typography variant="h6" gutterBottom>
                ...
                Estimulante y fortalecedor del sistema <b>nervioso</b>, <b>hormonal</b> y <b>cerebral</b>. Afrodisiaco en hombres y mujeres, ayuda a mejorar la <b>memoria</b> y combatir la <b>frigidez</b> e <b>impotencia sexual </b>
                </Typography>
